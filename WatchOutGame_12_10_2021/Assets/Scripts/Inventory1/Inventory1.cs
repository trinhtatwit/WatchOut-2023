...
[System.Serializable]
public class MarketInventory : ScriptableObject
{
    ...
    public List<MarketItem> myMasks = new List<MarketItem>();
    public MarketItem currentMask;
    public MarketItem currentGlove;
    public MarketItem currentFaceShield;
    public ItemDatabase maskDB;
    ...
    public void addMask(MarketItem newItem)
    {
        counts[newItem.id]++;
    ...
    public MarketItem ItemIdentify(int id)
    {
    ...
    public void setMask(MarketItem newItem)
    {
        currentMask = newItem;
    }

    public void setGlove(MarketItem newItem)
    {
        currentGlove = newItem;
    }

    public void setFaceShield(MarketItem newItem)
    {
    ...
    public List<MarketItem> GetMaskList()
    {
        return myMasks;
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
